-- Migration 00008: Eligibility Service (RPC)

-- This function evaluates if a supplier is fully eligible to participate in a procurement event
-- It checks Risk, Qualification, Classification, and Document status for a given scope.
